...
TEST(Vector3DAlias, bVec3IsA4DBoolVector)
{
...
TEST(Vector3DAlias, iVec3IsA4DIntVector)
{
...
TEST(Vector3DAlias, uVec3IsA4DUnsignedIntVector)
{
...
TEST(Vector3DAlias, vec4IsA4DFloatVector)
{
...
TEST(Vector3DAlias, lVec3IsA4DLongLongVector)
{
...
TEST(Vector3DAlias, dVec3IsA4DDoubleVector)
{
...
TEST(Vector3DAlias, ulVec3IsA4DUnsignedLongLongVector)
{
