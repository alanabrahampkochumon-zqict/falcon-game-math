...
//     constexpr fgm::Matrix3D MAT2(5, 6, 7, 8, 9, 10, 11, 12, 13);
//     constexpr fgm::Matrix3D BINARY_SUM = MAT1 + MAT2;
//
...
// {
//     const fgm::Matrix3D sum = this->_matA + this->_matB;
//
...
// {
//     constexpr fgm::Matrix3D mat1{ fgm::Vector3D{ 1.0f, 2.0f, 3.0f }, fgm::Vector3D{ -3.0f, -4.0f, 10.0f }, fgm::Vector3D{4.5f, 3.25f, 3.16f} };
//     constexpr fgm::Matrix3D mat2{ fgm::Vector3D{ 10.0, 2.0, -1.0 }, fgm::Vector3D{ 3.0, -8.0, 12.0 }, fgm::Vector3D {3.25, 5.1, 0.0} };
//     [[maybe_unused]] constexpr fgm::Matrix3D sum = mat1 + mat2;
//
