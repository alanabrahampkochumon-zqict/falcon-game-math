...
TYPED_TEST(Matrix3DDivision, DivideOperator_AlwaysReturnFloatingPointMatrix)
{
 ...
 *        return a floating-point matrix.
 */
TYPED_TEST(Matrix3DDivision, StaticWrapper_SafeDivide_AlwaysReturnFloatingPointMatrix)
{
