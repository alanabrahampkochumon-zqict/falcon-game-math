...
//{
//    const fgm::Matrix3D inverseScaledMat = this->_matrix.safeDiv(TypeParam(0), fgm::mat2d::zero<TypeParam>);
...
//{
//    const fgm::Matrix3D inverseScaledMat = GetParam().safeDiv(2.5, fgm::mat2d::zero<ParamType::value_type>);
//    EXPECT_MAT_ZERO(inverseScaledMat);
//}
//
//
...
//        fgm::Matrix3D<TypeParam>::safeDiv(this->_matrix, TypeParam(0), fgm::mat2d::zero<TypeParam>);
//    EXPECT_MAT_ZERO(inverseScaledMat);
//}
//
//
...
//{
//    using T = ParamType::value_type;
//    const fgm::Matrix3D inverseScaledMat = fgm::Matrix3D<T>::safeDiv(GetParam(), 2.5, fgm::mat2d::zero<T>);
//    EXPECT_MAT_ZERO(inverseScaledMat);
//}
//
//
...
//{
//    fgm::OperationStatus flag;
//    const fgm::Matrix3D inverseScaledMat = this->_matrix.tryDiv(TypeParam(0), flag, fgm::mat2d::zero<TypeParam>);
//
//    EXPECT_MAT_ZERO(inverseScaledMat);
//    EXPECT_EQ(fgm::OperationStatus::DIVISIONBYZERO, flag);
//}
...
//{
//    fgm::OperationStatus flag;
//    const fgm::Matrix3D inverseScaledMat = GetParam().tryDiv(2.5, flag, fgm::mat2d::zero<ParamType::value_type>);
//    EXPECT_MAT_ZERO(inverseScaledMat);
//    EXPECT_EQ(fgm::OperationStatus::NANOPERAND, flag);
//}
//
...
//    fgm::OperationStatus flag;
//    const fgm::Matrix3D inverseScaledMat =
//        fgm::Matrix3D<TypeParam>::tryDiv(this->_matrix, TypeParam(0), flag, fgm::mat2d::zero<TypeParam>);
//    EXPECT_MAT_ZERO(inverseScaledMat);
//    EXPECT_EQ(fgm::OperationStatus::DIVISIONBYZERO, flag);
//}
//
...
//    fgm::OperationStatus flag;
//    using T = ParamType::value_type;
//    [[maybe_unused]] const fgm::Matrix3D inverseScaledMat = fgm::Matrix3D<T>::tryDiv(GetParam(), T(0), flag);
//    EXPECT_EQ(fgm::OperationStatus::NANOPERAND, flag);
//}
//
//
...
//    using T = ParamType::value_type;
//    const fgm::Matrix3D inverseScaledMat =
//        fgm::Matrix3D<T>::tryDiv(GetParam(), 2.5, flag, fgm::mat2d::zero<ParamType::value_type>);
//    EXPECT_MAT_ZERO(inverseScaledMat);
//    EXPECT_EQ(fgm::OperationStatus::NANOPERAND, flag);
//}
