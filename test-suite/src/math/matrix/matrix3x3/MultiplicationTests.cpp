...
protected:
    ...
    void SetUp() override
    {
        _mat = { fgm::Vector3D{ T(7.12345678912345), T(13.12345678912345) },
...
//    void SetUp() override
//    {
//        _mat = { fgm::Vector3D{ T(0.1234568989329), T(0.1234214891234) },
//                 fgm::Vector3D{ T(-0.123489823149), T(-0.123489757623) } };
//        _vec = fgm::Vector3D{ T(0.8923764912287), T(0.78352829112384) };
//
//        _expectedColVector = fgm::Vector3D{ T(0.013412264184596345), T(0.013380716644514457) };
//        _expectedRowVector = fgm::Vector3D{ T(0.20687426274853477), T(-0.20695713384580372) };
//    }
//};
///**
// * @brief Test fixture for @ref fgm::Matrix3D vector multiplication with denormals,
...
namespace
{
    ...
    //static_assert(COL_VECTOR_PRODUCT[2] == 11);
    ...
    //static_assert(ROW_VEC_PRODUCT[2] == 10);
...
//{
//    constexpr fgm::Matrix3D mat(1.0, 2.0);
...
//{
//    constexpr fgm::Matrix3D mat(2.5, 3.5, 0.5, 1.5);
//    fgm::Vector3D vec(10, 20);
//    constexpr fgm::Vector3D expected(35, 65);
//
//    vec *= mat;
//
