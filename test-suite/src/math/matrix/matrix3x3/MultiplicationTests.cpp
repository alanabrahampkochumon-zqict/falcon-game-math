...
protected:
    ...
    void SetUp() override {
        _mat = {
            fgm::Vector3D{T(7), T(13), T(3)}, fgm::Vector3D{T(5), T(4), T(7)},
            fgm::Vector3D{T(5.5), T(11.25), T(25.3)}
        };
        _scalar = T(2.123456789123456);
        _expectedFloatingMat = {
            fgm::Vector3D{T(14.864197523864192), T(27.604938258604928), T(6.370370367370368)},
        ...
        _expectedIntegralMat = {
            fgm::Vector3D{T(14), T(26), T(6)}, fgm::Vector3D{T(10), T(8), T(14)},
...
protected:
    ...
    void SetUp() override {
        _mat = {
            fgm::Vector3D{T(7.12345678912345), T(13.12345678912345), T(1.32893912338)},
...
protected:
    ...
    void SetUp() override {
        _matA = {
            fgm::Vector3D{T(7.12345678912345), T(6.12345678912345), T(1.2389123488213)},
        ...
        _matB = {
            fgm::Vector3D{T(3.12345678912345), T(5.12345678912345), T(1.213849123421)},
        ...
        _expectedFloatingMat = {
            fgm::Vector3D{T(59.81499110074553), T(50.25262787869462), T(23.066325405048886)},
        ...
        _expectedIntegralMat = {
            fgm::Vector3D{T(55), T(46), T(18)}, fgm::Vector3D{T(89), T(76), T(24)},
...
protected:
    ...
    void SetUp() override {
        _matA = {
            fgm::Vector3D{T(0.1234568989329), T(0.1234214891234), T(0.382348912394)},
        ...
        _matB = {
            fgm::Vector3D{T(0.8923764912287), T(0.78352829112384), T(0.0523812349234)},
        ...
        _expectedMat = {
            fgm::Vector3D{T(0.014059119128298), T(0.041399312244975), T(0.365409472263106)},
