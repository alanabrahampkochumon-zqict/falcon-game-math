...
//    void SetUp() override
//    {
//        _matrix = { fgm::Vector3D{ T(5), T(4) }, fgm::Vector3D{ T(2), T(3) } };
//        _expectedInverse = { fgm::Vector3D{ Mag(0.42857142857142855), Mag(-0.5714285714285714) },
//                             fgm::Vector3D{ Mag(-0.2857142857142857), Mag(0.7142857142857143) } };
//    }
//};
...
//                         ::testing::Values(fgm::Matrix3D{ fgm::Vector3D{ 1.0f, 2.0f }, fgm::Vector3D{ 1.0f, 2.0f } },
//                                           fgm::Matrix3D{ fgm::Vector3D{ 2.0f, 2.0f }, fgm::Vector3D{ 2.0f, 2.0f } },
//                                           fgm::Matrix3D{ fgm::Vector3D{ 3.0f, 2.0f }, fgm::Vector3D{ 6.0f, 4.0f } },
//                                           fgm::Matrix3D{ fgm::Vector3D{ 0.0f, 0.0f }, fgm::Vector3D{ 4.0f, 5.0f } },
//                                           fgm::Matrix3D{ fgm::Vector3D{ 0.0f, 3.0f }, fgm::Vector3D{ 0.0f, 5.0f } }));
//
//
//
