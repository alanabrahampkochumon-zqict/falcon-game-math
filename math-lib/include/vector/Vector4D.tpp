...
namespace fgm {
    ...
    template<Arithmetic T>
    template<Arithmetic U>
    constexpr Vector4D<bool> Vector4D<
        T>::eq(const Vector4D &lhs, const Vector4D<U> &rhs, const double epsilon) noexcept {
    ...
    constexpr auto Vector4D<T>::operator*(const S scalar) const noexcept -> Vector4D<std::common_type_t<T, S> > requires
        StrictArithmetic<T> {
    ...
    template<Arithmetic T>
    template<StrictArithmetic S>
    constexpr auto Vector4D<T>::safeDiv(const S scalar) const noexcept -> Vector4D<std::common_type_t<T, S> > requires
        StrictArithmetic<T> {
        using R = std::common_type_t<T, S>;
    ...
    constexpr auto Vector4D<T>::safeDiv(const Vector4D &vec, const S scalar) noexcept
        -> Vector4D<std::common_type_t<T, S> > requires StrictArithmetic<T> {
    ...
    template<Arithmetic T>
    template<StrictArithmetic U>
    constexpr auto Vector4D<T>::dot(const Vector4D<U> &rhs) const noexcept -> std::common_type_t<T, U> requires
        StrictArithmetic<T> {
