...
namespace fgm
{
    ...
    constexpr Matrix4D<T>::Matrix4D() noexcept :  _data{ Vector4D{ T(1), T(0), T(0), T(0) }, Vector4D{ T(0), T(1), T(0), T(0) }, Vector4D{ T(0), T(0), T(1), T(0) }, Vector4D{ T(0), T(0), T(0), T(1) } } {}


    template <Arithmetic T>
    constexpr Matrix4D<T>::Matrix4D(T m00, T m01, T m02, T m03, T m10, T m11, T m12, T m13, T m20, T m21, T m22, T m23,
        T m30, T m31, T m32, T m33) noexcept:  _data{ Vector4D{ T(m00), T(m10), T(m20), T(m30) }, Vector4D{ T(m01), T(m11), T(m21), T(m31) }, Vector4D{ T(m02), T(m12), T(m22), T(m32) }, Vector4D{ T(m03), T(m13), T(m23), T(m33) } } {}


    template <Arithmetic T>
    constexpr Matrix4D<T>::Matrix4D(const Vector4D<T>& col0, const Vector4D<T>& col1, const Vector4D<T>& col2,
        const Vector4D<T>& col3) noexcept:_data{col0, col1, col2, col3} {}


    template <Arithmetic T>
    constexpr Matrix4D<T>::Matrix4D(T d0, T d1, T d2, T d3) noexcept:  _data{ Vector4D{ T(d0), T(0), T(0), T(0) }, Vector4D{ T(0), T(d1), T(0), T(0) }, Vector4D{ T(0), T(0), T(d2), T(0) }, Vector4D{ T(0), T(0), T(0), T(d3) } } {}
