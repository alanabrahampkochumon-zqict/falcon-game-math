 ...
 *
 * @brief Verify alias for @ref fgm::Vector2 returning correct data type.
 *
...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Vec2B, fgm::Vector2<int8_t>> && "Vec2B must be an alias of Vector2<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec2UB, fgm::Vector2<uint8_t>> && "Vec2UB must be an alias of Vector2<uint8_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec2I, fgm::Vector2<int32_t>> && "Vec2I must be an alias of Vector2<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec2U, fgm::Vector2<uint32_t>> && "Vec2U must be an alias of Vector2<uint32_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec2F, fgm::Vector2<float>> && "Vec2F must be an alias of Vector2<float>");
    ...
    static_assert(std::is_same_v<fgm::Vec2LL, fgm::Vector2<int64_t>> && "Vec2LL must be an alias of Vector2<int64_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec2D, fgm::Vector2<double>> && "Vec2D must be an alias of Vector2<double>");
    ...
    static_assert(std::is_same_v<fgm::Vec2ULL, fgm::Vector2<uint64_t>> &&
                  "Vec2ULL must be an alias of Vector2<uint64_t>");
} // namespace
