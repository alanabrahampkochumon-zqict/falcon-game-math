 ...
 *
 * @brief Verify alias for @ref fgm::Matrix2 returning correct data type.
 *
...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Mat2B, fgm::Matrix2<int8_t>> && "Mat2B must be an alias of Matrix2<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat2I, fgm::Matrix2<int32_t>> && "Mat2I must be an alias of Matrix2<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat2F, fgm::Matrix2<float>> && "Mat2F must be an alias of Matrix2<float>");
    ...
    static_assert(std::is_same_v<fgm::Mat2D, fgm::Matrix2<double>> && "Mat2D must be an alias of Matrix2<double>");
    ...
    static_assert(std::is_same_v<fgm::Mat2ULL, fgm::Matrix2<uint64_t>> &&
                  "Mat2ULL must be an alias of Matrix2<uint64_t>");
