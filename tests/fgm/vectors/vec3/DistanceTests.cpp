 ...
 */
TYPED_TEST(Vec3Distance, StaticWrapper_ChebyshevDist_ReturnsChebyshevDistance)
{
...
/** @brief Verify that the @ref fgm::Vec3::chebyshevDist function returns zero for the same vector. */
TYPED_TEST(Vec3Distance, StaticWrapper_ChebyshevDist_BetweenSameVectorReturnsZero)
{
    constexpr auto zero = TypeParam(0);
...
TYPED_TEST(Vec3DistanceSigned, StaticWrapper_ChebyshevDist_HandlesNegativeNumbers)
{
