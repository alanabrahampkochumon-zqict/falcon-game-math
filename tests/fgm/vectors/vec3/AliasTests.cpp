 ...
 *
 * @brief Verify alias for @ref fgm::Vec3 returning correct data type.
 *
...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Vec3B, fgm::Vec3<int8_t>> && "Vec3B must be an alias of Vec3<int8_t>");


    /** @test Verify @ref fgm::Vec3UB has `uint8_t` value_type. */
    static_assert(std::is_same_v<fgm::Vec3UB::value_type, uint8_t> && "Vec3UB must contain uint8_t elements");
    static_assert(std::is_same_v<fgm::Vec3UB, fgm::Vec3<uint8_t>> && "Vec3UB must be an alias of Vec3<uint8_t>");


    /** @test Verify @ref fgm::Vec3I has `int32_t` value_type. */
    static_assert(std::is_same_v<fgm::Vec3I::value_type, int32_t> && "Vec3I must contain int32_t elements");
    static_assert(std::is_same_v<fgm::Vec3I, fgm::Vec3<int32_t>> && "Vec3I must be an alias of Vec3<int32_t>");


    /** @test Verify @ref fgm::Vec3U has `uint32_t` value_type. */
    static_assert(std::is_same_v<fgm::Vec3U::value_type, uint32_t> && "Vec3U must contain uint32_t elements");
    static_assert(std::is_same_v<fgm::Vec3U, fgm::Vec3<uint32_t>> && "Vec3U must be an alias of Vec3<uint32_t>");


    /** @test Verify @ref fgm::Vec3F has `float` value_type. */
    static_assert(std::is_same_v<fgm::Vec3F::value_type, float> &&
                  "Vec3F must contain single precision floating point elements");
    static_assert(std::is_same_v<fgm::Vec3F, fgm::Vec3<float>> && "Vec3F must be an alias of Vec3<float>");


    /** @test Verify @ref fgm::Vec3LL has `int64t` value_type. */
    static_assert(std::is_same_v<fgm::Vec3LL::value_type, int64_t> && "Vec3LL must contain int64_t elements");
    static_assert(std::is_same_v<fgm::Vec3LL, fgm::Vec3<int64_t>> && "Vec3LL must be an alias of Vec3<int64_t>");


    /** @test Verify @ref fgm::Vec3D has `double` value_type. */
    static_assert(std::is_same_v<fgm::Vec3D::value_type, double> &&
                  "Vec3D must contain double precision floating point elements");
    static_assert(std::is_same_v<fgm::Vec3D, fgm::Vec3<double>> && "Vec3D must be an alias of Vec3<double>");


    /** @test Verify @ref fgm::Vec3ULL has `uint64_t` value_type. */
