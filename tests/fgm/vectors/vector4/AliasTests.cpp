 ...
 *
 * @brief Verify alias for @ref fgm::Vector4 returning correct data type.
 *
...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Vec4B, fgm::Vector4<int8_t>> && "Vec4B must be an alias of Vector4<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec4I, fgm::Vector4<int32_t>> && "Vec4I must be an alias of Vector4<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec4F, fgm::Vector4<float>> && "Vec4F must be an alias of Vector4<float>");
    ...
    static_assert(std::is_same_v<fgm::Vec4D, fgm::Vector4<double>> && "Vec4D must be an alias of Vector4<double>");
    ...
    static_assert(std::is_same_v<fgm::Vec4ULL, fgm::Vector4<uint64_t>> &&
                  "Vec4ULL must be an alias of Vector4<uint64_t>");
} // namespace
