 ...
 */
template <typename T>
class Vec2SwizzlingTest: public ::testing::Test
{};
TYPED_TEST_SUITE(Vec2SwizzlingTest, SupportedArithmeticTypes);
...
TYPED_TEST(Vec2SwizzlingTest, SwizzlingWorksAcrossDifferentTypes)
{
 ...
 */
TYPED_TEST(Vec2SwizzlingTest, StaticWrapper_SwizzlingWorksAcrossDifferentTypes)
{
    const fgm::Vec2 vector(TypeParam(1), TypeParam(2));
    const fgm::Vec2 expectedSwizzling(TypeParam(2), TypeParam(1));
