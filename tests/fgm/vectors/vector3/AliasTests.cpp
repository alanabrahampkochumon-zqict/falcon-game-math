 ...
 *
 * @brief Verify alias for @ref fgm::Vector3 returning correct data type.
 *
...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Vec3B, fgm::Vector3<int8_t>> && "Vec3B must be an alias of Vector3<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec3I, fgm::Vector3<int32_t>> && "Vec3I must be an alias of Vector3<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec3F, fgm::Vector3<float>> && "Vec3F must be an alias of Vector3<float>");
    ...
    static_assert(std::is_same_v<fgm::Vec3LL, fgm::Vector3<int64_t>> && "Vec3LL must be an alias of Vector3<int64_t>");
    ...
    static_assert(std::is_same_v<fgm::Vec3D, fgm::Vector3<double>> && "Vec3D must be an alias of Vector3<double>");
    ...
    static_assert(std::is_same_v<fgm::Vec3ULL, fgm::Vector3<uint64_t>> &&
                  "Vec3ULL must be an alias of Vector3<uint64_t>");
} // namespace
