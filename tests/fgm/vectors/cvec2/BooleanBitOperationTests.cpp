...
/**
 * @addtogroup T_FGM_CVec2_Bool_Bit
 * @{
 */
 ...
 */
TEST_F(BooleanCVec2BitOperationsTests, BitwiseAND_PerformComponentwiseConjunction)
{
 ...
 */
TEST_F(BooleanCVec2BitOperationsTests, CompoundBitwiseAND_PerformInPlaceConjunction)
{
 ...
 *       returns the correct boolean mask.
 */
TEST_F(BooleanCVec2BitOperationsTests, BitwiseOR_PerformComponentwiseDisjunction)
{
    const auto mask = this->_vecA | this->_vecB;
 ...
 *       and updates the calling vector with the resulting mask.
 */
TEST_F(BooleanCVec2BitOperationsTests, CompoundBitwiseOR_PerformInPlaceDisjunction)
{
    this->_vecA |= this->_vecB;
    EXPECT_VEC_EQ(this->_expectedConjunctionVector, this->_vecA);
}
 ...
 *       returns the correct boolean mask.
 */
TEST_F(BooleanCVec2BitOperationsTests, BitwiseNOT_PerformComponentwiseInversion)
{
