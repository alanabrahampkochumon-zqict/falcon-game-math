...
namespace
{
    ...
    /** @test Verify @ref fgm::Vec4UB has `uint8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Vec4I has `int32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Vec4U has `uint32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Vec4F has `float` value_type. */
    ...
    /** @test Verify @ref fgm::Vec4LL has `int64t` value_type. */
    ...
    /** @test Verify @ref fgm::Vec4D has `double` value_type. */
    ...
    /** @test Verify @ref fgm::Vec4ULL has `uint64_t` value_type. */
