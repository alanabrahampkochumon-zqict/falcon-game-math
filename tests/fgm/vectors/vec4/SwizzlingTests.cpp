 ...
 */
template <typename T>
class Vec4SwizzlingTest: public ::testing::Test
{};
TYPED_TEST_SUITE(Vec4SwizzlingTest, SupportedArithmeticTypes);
...
TYPED_TEST(Vec4SwizzlingTest, SwizzlingWorksAcrossDifferentTypes)
{
...
TYPED_TEST(Vec4SwizzlingTest, StaticVariant_SwizzlingWorksAcrossDifferentTypes)
{
    const fgm::Vec4 vector(TypeParam(1), TypeParam(2), TypeParam(3), TypeParam(4));
    const fgm::Vec4 expectedSwizzling(TypeParam(4), TypeParam(3), TypeParam(2), TypeParam(1));
