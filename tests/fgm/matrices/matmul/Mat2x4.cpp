...
namespace
{
    ...
    protected:
        ...
        fgm::Mat2x4<T> _mat2x3, _expectedFPMat2x4, _expectedIntMat2x4;
        ...
        void SetUp() override
        {
            ...
            _expectedFPMat2x4  = { fgm::Vec2{ T(62.58970657609299337), T(135.70484449309299180) },
                                   fgm::Vec2{ T(69.55553299309298154), T(151.67067091009300839) },
                                   fgm::Vec2{ T(76.52135941009299813), T(167.63649732709299656) } };
            _expectedIntMat2x4 = { fgm::Vec2{ T(54), T(126) }, fgm::Vec2{ T(60), T(141) }, fgm::Vec2{ T(66), T(156) } };
    ...
    /** @brief Test fixture for @ref fgm::Mat2x4 multiplication, parameterized by @ref SupportedArithmeticTypes. */
    ...
    {
        // STATIC TEST SETUP
        constexpr fgm::Mat2x4 MAT2X3(1, 2, 3, 4, 5, 6);
...
TYPED_TEST(Mat2x4Multiplication, Mat2x4Times3DVector_ReturnsAValid2DVector)
{
    const auto expectedVector = this->_mat2x3 * this->_vec3x1;
