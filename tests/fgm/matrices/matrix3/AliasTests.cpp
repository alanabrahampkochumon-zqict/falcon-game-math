 ...
 *
 * @brief Verify alias for @ref fgm::Matrix3 returning correct data type.
 *
...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Mat3B, fgm::Matrix3<int8_t>> && "Mat3B must be an alias of Matrix3<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat3UB, fgm::Matrix3<uint8_t>> && "Mat3UB must be an alias of Matrix3<uint8_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat3I, fgm::Matrix3<int32_t>> && "Mat3I must be an alias of Matrix3<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat3U, fgm::Matrix3<uint32_t>> && "Mat3U must be an alias of Matrix3<uint32_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat3F, fgm::Matrix3<float>> && "Mat3F must be an alias of Matrix3<float>");
    ...
    static_assert(std::is_same_v<fgm::Mat3LL, fgm::Matrix3<int64_t>> && "Mat3LL must be an alias of Matrix3<int64_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat3D, fgm::Matrix3<double>> && "Mat3D must be an alias of Matrix3<double>");
    ...
    static_assert(std::is_same_v<fgm::Mat3ULL, fgm::Matrix3<uint64_t>> &&
                  "Mat3ULL must be an alias of Matrix3<uint64_t>");
