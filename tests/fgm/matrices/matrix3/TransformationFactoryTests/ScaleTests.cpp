...
template <typename T>
class Mat3UniformScale: public testing::Test
{
protected:
 ...
 */
TYPED_TEST_SUITE(Mat3UniformScale, SupportedArithmeticTypes);


template <typename T>
class Mat3NonUniformScale: public ::testing::Test
{
protected:
    fgm::Mat3<T> _expectedMat;
...
/**
 * @brief Test fixture for @ref fgm::Mat3 non-uniform scale factory, parameterized
 *        @ref SupportedArithmeticTypes
 */
TYPED_TEST_SUITE(Mat3NonUniformScale, SupportedArithmeticTypes);
...
{
    // Uniform scale
    constexpr auto U_SCALE_MAT = fgm::Mat3<int>::makeScale(2);
    ...
    // Non-uniform scale
    constexpr auto SCALE_MAT = fgm::Mat3<int>::makeScale(2, 3, 4);
...
TYPED_TEST(Mat3UniformScale, ReturnsScaleMatrix)
{
...
TYPED_TEST(Mat3NonUniformScale, ReturnsScaleMatrix)
{
