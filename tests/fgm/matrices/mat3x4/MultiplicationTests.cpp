...
TYPED_TEST(Mat3x4ScalarMultiplicationTests, TimesEqualsOperator_MatrixTimesEqualScalarIsTheSameMatrixScaled)
{
...
TYPED_TEST(Mat3x4ScalarMultiplicationTests, TimesOperator_MixedType_PromotesType)
{
