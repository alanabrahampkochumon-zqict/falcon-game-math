...
/** @test Verify that fgm::Mat3x4[] are alias wrappers for integral and floating-point 4D matrix. */
namespace
{
    /** @test Verify @ref fgm::Mat3x4B has `int8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3x4UB has `uint8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3x4I has `int32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3x4U has `uint32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3x4F has `float` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3x4LL has `int64_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3x4D has `double` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3x4ULL has `uint64_t` value_type. */
