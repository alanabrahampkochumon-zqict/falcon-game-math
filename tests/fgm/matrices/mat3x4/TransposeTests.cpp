...
namespace
{
     ...
     */
    template <typename T>
    class Mat3x4Transpose: public ::testing::Test
    {
    protected:
    ...
    TYPED_TEST_SUITE(Mat3x4Transpose, SupportedTypes);
...
TYPED_TEST(Mat3x4Transpose, StaticWrapper_Returns4x3MatrixWithRowAndColumnElementsExchanged)
