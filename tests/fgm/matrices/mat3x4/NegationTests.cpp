...
template <typename T>
class Mat3x4Negation: public ::testing::Test
{
protected:
...
/** @brief Test fixture for @ref fgm::Mat3x4 negation, parameterized by @ref SupportedSignedArithmeticTypes. */
TYPED_TEST_SUITE(Mat3x4Negation, SupportedSignedArithmeticTypes);
 ...
 */
TYPED_TEST(Mat3x4Negation, PlusOperator_ReturnsMatrixSum)
{
