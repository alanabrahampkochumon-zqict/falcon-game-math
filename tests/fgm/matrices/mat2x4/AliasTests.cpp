...
namespace
{
    ...
    /** @test Verify @ref fgm::Mat2x4UB has `uint8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat2x4I has `int32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat2x4U has `uint32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat2x4F has `float` value_type. */
    ...
    /** @test Verify @ref fgm::Mat2x4LL has `int64_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat2x4D has `double` value_type. */
    ...
    /** @test Verify @ref fgm::Mat2x4ULL has `uint64_t` value_type. */
