...
namespace
{
    ...
    protected:
        ...
        void SetUp() override
        {
            ...
            _expectedFPMat2x4x4D  = { fgm::Vec2{ T(67.53826583649818360), T(45.22504796609911892) },
            ...
            _expectedIntMat2x4x4D = { fgm::Vec2{ T(66), T(44) }, fgm::Vec2{ T(27), T(21) }, fgm::Vec2{ T(50), T(30) },
                                      fgm::Vec2{ T(64), T(54) } };

            _expectedFPMat2Dx2x4  = { fgm::Vec2{ T(11.04578567005615142), T(23.55624222506261845) },
                                      fgm::Vec2{ T(3.51966093089763676), T(7.18483700655947821) },
                                      fgm::Vec2{ T(17.26757951015333603), T(35.25796945115762071) },
                                      fgm::Vec2{ T(5.00058545554098011), T(10.50363433464453600) } };
            _expectedIntMat2Dx2x4 = { fgm::Vec2{ T(9), T(23) }, fgm::Vec2{ T(3), T(7) }, fgm::Vec2{ T(15), T(35) },
                                      fgm::Vec2{ T(4), T(10) } };
...
TYPED_TEST(Mat2x4Composition, Mat2x4TimesMat4_ReturnsAValid2x4Matrix)
{
    ...
    if constexpr (std::is_floating_point_v<TypeParam>)
    {
        EXPECT_MAT_EQ(this->_expectedFPMat2x4x4D, matrixProduct);
    }
    else
    {
        EXPECT_MAT_EQ(this->_expectedIntMat2x4x4D, matrixProduct);
    }
}
...
TYPED_TEST(Mat2x4Composition, Mat2TimesMat2x4_ReturnsAValid2x4Matrix)
{
    ...
    if constexpr (std::is_floating_point_v<TypeParam>)
    {
        EXPECT_MAT_EQ(this->_expectedFPMat2Dx2x4, matrixProduct);
    }
    else
    {
        EXPECT_MAT_EQ(this->_expectedIntMat2Dx2x4, matrixProduct);
    }
}
