...
/** @test Verify that fgm::Mat4x3[] are alias wrappers for integral and floating-point 4D matrix. */
namespace
{
    /** @test Verify @ref fgm::Mat4x3B has `int8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x3UB has `uint8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x3I has `int32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x3U has `uint32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x3F has `float` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x3LL has `int64_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x3D has `double` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x3ULL has `uint64_t` value_type. */
