...
/**
 * @addtogroup T_FGM_Mat2x3_Subtraction
 * @{
 */
...
TEST(Mat2x3Subtraction, MinusOperator_MixedType_PromotesType)
{
...
TEST(Mat2x3Subtraction, MinusEqualsOperator_MixedType_DoesNotPromoteType)
{
