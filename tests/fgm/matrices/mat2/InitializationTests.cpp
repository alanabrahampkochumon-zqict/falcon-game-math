...
template <typename T>
class Mat2Initialization: public ::testing::Test
{
protected:
...
/** Test fixture for @ref fgm::Mat2 initialization, parameterized by @ref SupportedTypes. */
TYPED_TEST_SUITE(Mat2Initialization, SupportedTypes);
...
TYPED_TEST(Mat2Initialization, EmptyConstructorReturnsIdentityMatrix)
{
...
TYPED_TEST(Mat2Initialization, ParameterizedConstructorInitializesMatrixWithVectors)
{
...
TYPED_TEST(Mat2Initialization, ParameterizedConstructorInitializesDiagonalMatrix)
{
...
TYPED_TEST(Mat2Initialization, CanBeConstructedWithBracedInitialization)
{
