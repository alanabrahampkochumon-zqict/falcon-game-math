...
template <typename T>
class Mat4x2Division: public ::testing::Test
{
protected:
...
/** Test fixture for @ref fgm::Mat4x2 division, parameterized by @ref SupportedArithmeticTypes */
TYPED_TEST_SUITE(Mat4x2Division, SupportedArithmeticTypes);


/** @brief Test fixture for @ref fgm::Mat4x2 division with NaN vectors. */
class NaNMat4x2Division: public ::testing::TestWithParam<fgm::Mat4x2<float>>
{};
INSTANTIATE_TEST_SUITE_P(
    Mat4x2DivisionTestSuite, NaNMat4x2Division,
 ...
 */
TYPED_TEST(Mat4x2Division, DivideOperator_ReturnsInverseScaledMatrix)
{
...
TYPED_TEST(Mat4x2Division, DivideOperator_ByZeroTriggersAssertInDebugMode)
 ...
 */
TYPED_TEST(Mat4x2Division, DivideEqualsOperator_InverseScalesMatrixInPlace)
{
...
/** @brief Verify that assertion is triggered when dividing by zero (compound division) in **Debug Mode**. */
TYPED_TEST(Mat4x2Division, DivideEqualsOperator_ByZeroTriggersAssertInDebugMode)
...
/**
 * @brief Verify that dividing a matrix using @ref fgm::Mat4x2::safeDiv perform an element-wise divide
 *        and returns a new matrix instance.
 */
TYPED_TEST(Mat4x2Division, SafeDivide_ReturnsInverseScaledMatrix)
{
...
/**
 * @brief Verify that dividing a matrix by zero using @ref fgm::Mat4x2::safeDiv
 *        returns identity matrix by default.
 */
TYPED_TEST(Mat4x2Division, SafeDivide_DivisionByZeroReturnsIdentityMatrixByDefault)
{
 ...
 */
TYPED_TEST(Mat4x2Division, SafeDivide_DivisionByZeroReturnsPassedInFallback)
{
...
/**
 * @brief Verify that dividing a NaN matrix using @ref fgm::Mat4x2::safeDiv
 *        returns identity matrix by default.
 */
TEST_P(NaNMat4x2Division, SafeDivide_ReturnsIdentityMatrixByDefault)
{
 ...
 *        returns passed-in fallback.
 */
TEST_P(NaNMat4x2Division, SafeDivide_ReturnsPassedInFallback)
{
...
/**
 * @brief Verify that dividing a matrix using the static variant of @ref fgm::Mat4x2::safeDiv
 *        perform an element-wise divide and returns a new matrix instance.
 */
TYPED_TEST(Mat4x2Division, SafeDivide_StaticWrapper_ReturnsInverseScaledMatrix)
{
...
/**
 * @brief Verify that dividing a matrix by zero using the static variant of @ref fgm::Mat4x2::safeDiv
 *        returns identity matrix by default.
 */
TYPED_TEST(Mat4x2Division, StaticWrapper_SafeDivide_DivisionByZeroReturnsIdentityMatrixByDefault)
{
 ...
 *        returns passed-in fallback.
 */
TYPED_TEST(Mat4x2Division, StaticWrapper_SafeDivide_DivisionByZeroReturnsPassedInFallback)
{
...
/**
 * @brief Verify that dividing a NaN matrix using the static variant of @ref fgm::Mat4x2::safeDiv
 *        returns identity matrix by default.
 */
TEST_P(NaNMat4x2Division, StaticWrapper_SafeDivide_ReturnsIdentityMatrixByDefault)
{
 ...
 *        returns passed-in fallback.
 */
TEST_P(NaNMat4x2Division, StaticWrapper_SafeDivide_ReturnsPassedInFallback)
{
    using T                            = ParamType::value_type;
 ...
 */
TYPED_TEST(Mat4x2Division, TryDivide_ReturnsInverseScaledMatrixAndSetsCorrectFlag)
{
 ...
 */
TYPED_TEST(Mat4x2Division, TryDivide_DivisionByZeroReturnsIdentityMatrixByDefaultAndSetsCorrectFlag)
{
    fgm::OperationStatus flag;
 ...
 */
TYPED_TEST(Mat4x2Division, TryDivide_DivisionByZeroReturnsPassedInFallbackAndSetsCorrectFlag)
{
    fgm::OperationStatus flag;
...
/**
 * @brief Verify that dividing a NaN matrix using @ref fgm::Mat4x2::tryDiv returns identity matrix
 *        by default and set flag to @ref OperationStatus::NANOPERAND.
 */
TEST_P(NaNMat4x2Division, TryDivide_ReturnsIdentityMatrixByDefault)
{
    fgm::OperationStatus flag;
 ...
 */
TEST_P(NaNMat4x2Division, TryDivide_ReturnsPassedInFallback)
{
    fgm::OperationStatus flag;
 ...
 */
TEST_P(NaNMat4x2Division, TryDivide_NaNOperandTakesPrecedenceOverZeroDivision)
{
    fgm::OperationStatus flag;
 ...
 */
TYPED_TEST(Mat4x2Division, StaticWrapper_TryDivide_ReturnsInverseScaledMatrixAndSetsCorrectFlag)
{
    fgm::OperationStatus flag;
 ...
 *        returns identity matrix by default and set flag to @ref OperationStatus::DIVISIONBYZERO.
 */
TYPED_TEST(Mat4x2Division, StaticWrapper_TryDivide_DivisionByZeroReturnsIdentityMatrixByDefaultAndSetsCorrectFlag)
{
    fgm::OperationStatus flag;
 ...
 */
TYPED_TEST(Mat4x2Division, StaticWrapper_TryDivide_DivisionByZeroReturnsPassedInFallbackAndSetsCorrectFlag)
{
    fgm::OperationStatus flag;
    const fgm::Mat4x2 inverseScaledMat =
 ...
 */
TEST_P(NaNMat4x2Division, StaticWrapper_TryDivide_ReturnsIdentityMatrixByDefault)
{
    fgm::OperationStatus flag;
    using T                            = ParamType::value_type;
 ...
 */
TEST_P(NaNMat4x2Division, StaticWrapper_TryDivide_NaNOperandTakesPrecedenceOverZeroDivision)
{
    fgm::OperationStatus flag;
    using T                                             = ParamType::value_type;
 ...
 *        returns passed-in fallback and set flag to @ref OperationStatus::NANOPERAND.
 */
TEST_P(NaNMat4x2Division, StaticWrapper_TryDivide_ReturnsPassedInFallback)
{
    fgm::OperationStatus flag;
    using T = ParamType::value_type;
    const fgm::Mat4x2 inverseScaledMat =
