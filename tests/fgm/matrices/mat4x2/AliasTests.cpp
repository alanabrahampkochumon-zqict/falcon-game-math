...
/** @test Verify that fgm::Mat4x2[] are alias wrappers for integral and floating-point 4D matrix. */
namespace
{
    /** @test Verify @ref fgm::Mat4x2B has `int8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x2UB has `uint8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x2I has `int32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x2U has `uint32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x2F has `float` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x2LL has `int64_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x2D has `double` value_type. */
    ...
    /** @test Verify @ref fgm::Mat4x2ULL has `uint64_t` value_type. */
