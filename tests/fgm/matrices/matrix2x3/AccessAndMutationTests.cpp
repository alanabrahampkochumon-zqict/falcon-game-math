...
namespace
{
    constexpr fgm::Matrix2x3 MAT(1, 2, 3, 4, 5, 6);
...
{
    constexpr fgm::Matrix2x3 mat(1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f);
...
{
    const fgm::Matrix2x3 mat(1, 2, 3, 4, 5, 6);
...
{
    [[maybe_unused]] fgm::Matrix2x3 mat(1, 2, 3, 4, 5, 6);
    const auto col = GetParam();
