...
template <typename T>
class Mat4UniformScale: public testing::Test
{
protected:
    ...
    void SetUp() override
    {
        _expectedMat = { fgm::Vec4{ T(5.3821839321), T(0), T(0), T(0) }, fgm::Vec4{ T(0), T(5.3821839321), T(0), T(0) },
                         fgm::Vec4{ T(0), T(0), T(5.3821839321), T(0) }, fgm::Vec4{ T(0), T(0), T(0), T(1) } };
        _scale       = T(5.3821839321);
    }
};
/**
 * @brief Test fixture for @ref fgm::Mat4 uniform scale factory, parameterized
 *        @ref SupportedArithmeticTypes
 */
TYPED_TEST_SUITE(Mat4UniformScale, SupportedArithmeticTypes);


template <typename T>
class Mat4NonUniformScale: public testing::Test
{
protected:
    fgm::Mat4<T> _expectedMat;
    ...
    void SetUp() override
    {
        _expectedMat = { fgm::Vec4{ T(5.3821839321), T(0), T(0), T(0) }, fgm::Vec4{ T(0), T(8.1234921348), T(0), T(0) },
...
/**
 * @brief Test fixture for @ref fgm::Mat4 non-uniform scale factory, parameterized
 *        @ref SupportedArithmeticTypes
 */
TYPED_TEST_SUITE(Mat4NonUniformScale, SupportedArithmeticTypes);
...
{
    // Uniform scale
    constexpr auto U_SCALE_MAT = fgm::Mat4<int>::makeScale(2);
    ...
    // Non-uniform scale
    constexpr auto SCALE_MAT = fgm::Mat4<int>::makeScale(2, 3, 4);
...
TYPED_TEST(Mat4UniformScale, ReturnsScaleMatrix)
{
...
TYPED_TEST(Mat4NonUniformScale, ReturnsScaleMatrix)
{
