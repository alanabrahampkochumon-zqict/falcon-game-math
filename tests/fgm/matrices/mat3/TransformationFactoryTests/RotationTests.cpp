...
template <typename T>
class Mat3Rotation: public testing::Test
{
protected:
...
/**
 * @brief Test fixture for @ref fgm::Mat3 rotation factory, parameterized
 ...
 */
TYPED_TEST_SUITE(Mat3FloatRotation, SupportedFloatingPointTypes);
