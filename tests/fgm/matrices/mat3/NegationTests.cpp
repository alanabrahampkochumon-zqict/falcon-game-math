...
template <typename T>
class Mat3Negation: public ::testing::Test
{
protected:
...
/** @brief Test fixture for @ref fgm::Mat3 negation, parameterized by @ref SupportedSignedArithmeticTypes. */
TYPED_TEST_SUITE(Mat3Negation, SupportedSignedArithmeticTypes);
 ...
 */
TYPED_TEST(Mat3Negation, PlusOperator_ReturnsMatrixSum)
{
