...
namespace
{
    ...
    /** @test Verify @ref fgm::Mat3UB has `uint8_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3I has `int32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3U has `uint32_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3F has `float` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3LL has `int64_t` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3D has `double` value_type. */
    ...
    /** @test Verify @ref fgm::Mat3ULL has `uint64_t` value_type. */
    static_assert(std::is_same_v<fgm::Mat3ULL::value_type, uint64_t> && "Mat3ULL must contain uint64_t elements");
    static_assert(std::is_same_v<fgm::Mat3ULL, fgm::Mat3<uint64_t>> && "Mat3ULL must be an alias of Mat3<uint64_t>");
