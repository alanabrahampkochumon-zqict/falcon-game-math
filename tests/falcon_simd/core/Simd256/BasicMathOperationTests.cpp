...
{
    /**
     * @brief Test Fixture for Simd256 basic math operations like min, max, abs etc.
     */
    template <typename T>
    class Simd256BasicMathTests: public testing::Test
    {
    public:
    ...
    TYPED_TEST_SUITE(Simd256BasicMathTests, Simd256RegisterTypeHints);

} // namespace



TYPED_TEST(Simd256BasicMathTests, Min_ReturnsARegisterWithMinimumValuesFromEitherRegister)
{
...
TYPED_TEST(Simd256BasicMathTests, HorizontalMin_ReturnsTheMaxValueFromTheRegister)
{
    using Type            = TypeParam::Type;
    constexpr size_t Lane = TypeParam::VALUE;
