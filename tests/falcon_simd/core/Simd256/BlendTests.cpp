...
namespace
{
    ...
    using Simd256BlendTestTypeHints = testing::Types<
        // Unsigned types
        Simd256BlendTestParam<U8, 2, Array<U8, 2>{ 100, 24 }, Array<U8, 2>{ 32, 15 }, Array<U8, 2>{ 0, ONE<U8> },
                              Array<U8, 2>{ 100, 15 }>,
        Simd256BlendTestParam<U8, 4, Array<U8, 4>{ 100, 24, 13, 15 }, Array<U8, 4>{ 32, 15, 61, 14 },
                              Array<U8, 4>{ 0, ONE<U8>, ONE<U8>, 0 }, Array<U8, 4>{ 100, 15, 61, 15 }>,
        Simd256BlendTestParam<U8, 8, Array<U8, 8>{ 100, 24, 13, 15, 32, 15, 71, 44 },
                              Array<U8, 8>{ 32, 15, 61, 14, 46, 55, 21, 74 },
                              Array<U8, 8>{ 0, ONE<U8>, ONE<U8>, 0, ONE<U8>, 0, 0, ONE<U8> },
                              Array<U8, 8>{ 100, 15, 61, 15, 46, 15, 71, 74 }>,
        Simd256BlendTestParam<U8, 16, Array<U8, 16>{ 100, 24, 13, 15, 32, 15, 71, 44, 100, 24, 13, 15, 32, 15, 71, 44 },
        ...
        Simd256BlendTestParam<U16, 2, Array<U16, 2>{ 100, 24 }, Array<U16, 2>{ 32, 15 }, Array<U16, 2>{ 0, ONE<U16> },
                              Array<U16, 2>{ 100, 15 }>,
        Simd256BlendTestParam<U16, 4, Array<U16, 4>{ 100, 24, 13, 15 }, Array<U16, 4>{ 32, 15, 61, 14 },
                              Array<U16, 4>{ 0, ONE<U16>, ONE<U16>, 0 }, Array<U16, 4>{ 100, 15, 61, 15 }>,
        Simd256BlendTestParam<U16, 8, Array<U16, 8>{ 100, 24, 13, 15, 32, 15, 71, 44 },
        ...
        Simd256BlendTestParam<U32, 2, Array<U32, 2>{ 100, 24 }, Array<U32, 2>{ 32, 15 }, Array<U32, 2>{ 0, ONE<U32> },
                              Array<U32, 2>{ 100, 15 }>,
        Simd256BlendTestParam<U32, 4, Array<U32, 4>{ 100, 24, 13, 15 }, Array<U32, 4>{ 32, 15, 61, 14 },
                              Array<U32, 4>{ 0, ONE<U32>, ONE<U32>, 0 }, Array<U32, 4>{ 100, 15, 61, 15 }>,
        Simd256BlendTestParam<U64, 2, Array<U64, 2>{ 100, 24 }, Array<U64, 2>{ 32, 15 }, Array<U64, 2>{ 0, ONE<U32> },
                              Array<U64, 2>{ 100, 15 }>,

        // Signed types
        Simd256BlendTestParam<I8, 2, Array<I8, 2>{ 100, 24 }, Array<I8, 2>{ 32, 15 }, Array<I8, 2>{ 0, ONE<I8> },
                              Array<I8, 2>{ 100, 15 }>,
        Simd256BlendTestParam<I8, 4, Array<I8, 4>{ 100, 24, 13, 15 }, Array<I8, 4>{ 32, 15, 61, 14 },
                              Array<I8, 4>{ 0, ONE<I8>, ONE<I8>, 0 }, Array<I8, 4>{ 100, 15, 61, 15 }>,
        Simd256BlendTestParam<I8, 8, Array<I8, 8>{ 100, 24, 13, 15, 32, 15, 71, 44 },
                              Array<I8, 8>{ 32, 15, 61, 14, 46, 55, 21, 74 },
                              Array<I8, 8>{ 0, ONE<I8>, ONE<I8>, 0, ONE<I8>, 0, 0, ONE<I8> },
                              Array<I8, 8>{ 100, 15, 61, 15, 46, 15, 71, 74 }>,

        Simd256BlendTestParam<I8, 16, Array<I8, 16>{ 100, 24, 13, 15, 32, 15, 71, 44, 100, 24, 13, 15, 32, 15, 71, 44 },
        ...
        Simd256BlendTestParam<I16, 2, Array<I16, 2>{ 100, 24 }, Array<I16, 2>{ 32, 15 }, Array<I16, 2>{ 0, ONE<I16> },
                              Array<I16, 2>{ 100, 15 }>,
        Simd256BlendTestParam<I16, 4, Array<I16, 4>{ 100, 24, 13, 15 }, Array<I16, 4>{ 32, 15, 61, 14 },
                              Array<I16, 4>{ 0, ONE<I16>, ONE<I16>, 0 }, Array<I16, 4>{ 100, 15, 61, 15 }>,
        Simd256BlendTestParam<I16, 8, Array<I16, 8>{ 100, 24, 13, 15, 32, 15, 71, 44 },
        ...
        Simd256BlendTestParam<I32, 2, Array<I32, 2>{ 100, 24 }, Array<I32, 2>{ 32, 15 }, Array<I32, 2>{ 0, ONE<I32> },
                              Array<I32, 2>{ 100, 15 }>,
        Simd256BlendTestParam<I32, 4, Array<I32, 4>{ 100, 24, 13, 15 }, Array<I32, 4>{ 32, 15, 61, 14 },
                              Array<I32, 4>{ 0, ONE<I32>, ONE<I32>, 0 }, Array<I32, 4>{ 100, 15, 61, 15 }>,
        Simd256BlendTestParam<I64, 2, Array<I64, 2>{ 100, 24 }, Array<I64, 2>{ 32, 15 }, Array<I64, 2>{ 0, ONE<I32> },
                              Array<I64, 2>{ 100, 15 }>,

        // Floating point types
        Simd256BlendTestParam<FP32, 2, Array<FP32, 2>{ 100.0f, 24.123849f }, Array<FP32, 2>{ 32.123f, 15.456f },
                              Array<FP32, 2>{ 0, ONE<FP32> }, Array<FP32, 2>{ 100.0f, 15.456f }>,
        Simd256BlendTestParam<FP32, 4, Array<FP32, 4>{ 100.0f, 24.123849f, 13.1234f, 15.482f },
        ...
        Simd256BlendTestParam<FP64, 2, Array<FP64, 2>{ 100.0, 24.123849 }, Array<FP64, 2>{ 32.123, 15.456 },
