 ...
 *
 * @brief Templated 2x3 Matrix supporting integral, floating-point, and boolean types.
 *
 * @details Provide high-performance 2x3 matrix implementation with SIMD acceleration
...
namespace fgm
{
    ...
    struct Matrix2x3
    {
        ...
        /**
         * @brief Initialize an uninitialized @ref Matrix2x3 instance.
         *
         ...
         *       @ref fgm::Matrix2x3<T>::ZERO() to guarantee a zeroed matrix.
         */
        Matrix2x3() = default;


        /**
         * @brief Initialize a 2x3 matrix from the passed-in scalar elements.
         *
         ...
         */
        [[nodiscard]] constexpr Matrix2x3(T m00, T m01, T m02, T m10, T m11, T m12) noexcept;
        ...
        /**
         * @brief Initialize @ref Matrix2x3 from another @ref Matrix2x3 of a different type.
         *
        ...
        [[nodiscard]] explicit constexpr Matrix2x3(const Matrix2x3<U>& other) noexcept;
         ...
         *
         * @return A new @ref Matrix2x3 containing the element-wise difference.
         */
        template <StrictArithmetic U>
            requires StrictSignedness<T, U>
        [[nodiscard]] constexpr PromotedMatrix2x3<T, U> operator-(const Matrix2x3<U>& rhs) const noexcept
        ...
        //      * @param[in] scalar The value to scale by.
        //      *
        //      * @return A new @ref Matrix2x3 inverse scaled by @p scalar.
        //      */
        //     template <StrictArithmetic S>
        //     [[nodiscard]] constexpr PromotedMatrix2x3<T, S> operator/(const S& scalar) const noexcept
        //         requires StrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      */
        //     template <StrictArithmetic S>
        //     constexpr Matrix2x3& operator/=(const S& scalar) noexcept
        //         requires StrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      * @param[in] fallback The default matrix to return, when an invalid case is hit like a zero scalar or a
        //      NaN
        //      *                     element.
        //      *
        //      * @return A new @ref Matrix2x3 resulting from the division or @p fallback if the @p scalar is below the
        //      *         epsilon threshold or if the matrix has a NaN(Not-a-Number) element(s).
        //      */
        //     template <StrictArithmetic S>
        //     [[nodiscard]] constexpr PromotedMatrix2x3<T, S> safeDiv(S scalar,
        //                                                           const Matrix2x3& fallback = Matrix2x3::EYE()) const
        //                                                           noexcept
        //         requires StrictArithmetic<T>;
        //
        //
        ...
        //      */
        //     template <StrictArithmetic S>
        //     [[nodiscard]] static constexpr PromotedMatrix2x3<T, S> safeDiv(const Matrix2x3& mat, S scalar,
        //                                                                  const Matrix2x3& fallback =
        //                                                                  Matrix2x3::EYE()) noexcept
        //         requires StrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      * @note Promotes the result to the wider type using @ref PromotedMatrix2x3<T, S>.
        //      * @note Operation is restricted to numeric types via @ref StrictArithmetic.
        //      * @note Returns @ref fallback if attempting to divide by zero (or below the epsilon threshold), or if
        //      any
        //      *       operand contains NaN.
        ...
        //      */
        //     template <StrictArithmetic S>
        //     [[nodiscard]] constexpr PromotedMatrix2x3<T, S> tryDiv(S scalar, OperationStatus& status,
        //                                                          const Matrix2x3& fallback = Matrix2x3::EYE()) const
        //                                                          noexcept
        //         requires StrictArithmetic<T>;
        //
        ...
        //      */
        //     template <StrictArithmetic S>
        //     [[nodiscard]] static constexpr PromotedMatrix2x3<T, S> tryDiv(const Matrix2x3& mat, S scalar,
        //                                                                 OperationStatus& status,
        //                                                                 const Matrix2x3& fallback = Matrix2x3::EYE())
        //                                                                 noexcept
        //         requires StrictArithmetic<T>;
        //
        //     /** @} */
        ...
        //      * @return A non-zero scalar if the matrix is non-singular, else zero.
        //      */
        //     static constexpr T determinant(const Matrix2x3& matrix) noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      *        \f$
        //      *
        //      * @return A new @ref Matrix2x3 with its elements flipped along the diagonal.
        //      */
        //     [[nodiscard("Transpose does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     constexpr Matrix2x3 transpose() const noexcept;
        //
        //
        //     /**
        ...
        //      */
        //     [[nodiscard("Transpose does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     static constexpr Matrix2x3 transpose(const Matrix2x3& matrix) noexcept;
        //
        //
        //     /**
        ...
        //      *
        //      * @return A new @ref Matrix2x3 such that \f$ A \cdot A^{-1} = I \f$.
        //      */
        //     [[nodiscard("Inverse does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     constexpr Matrix2x3<Magnitude<T>> inverse() const noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      */
        //     [[nodiscard("Inverse does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     static constexpr Matrix2x3<Magnitude<T>> inverse(const Matrix2x3& matrix) noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      *            \end{bmatrix}
        //      *        \f$
        //      * @note If the determinant is zero (or below the epsilon threshold) or this matrix contains NaN
        //      elements,
        //      *       returns @p fallback.
        //      * @note Promotes the result to a floating point result using @ref Magnitude.
        //      * @note Operation is restricted to **signed** numeric types via @ref SignedStrictArithmetic.
        ...
        //      *
        //      * @return  A new @ref Matrix2x3 such that \f$ A \cdot A^{-1} = I \f$ or
        //      *          @p fallback if this matrix is a singular matrix or has NaN(Not-a-Number) element(s).
        //      */
        //     [[nodiscard("Inverse does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     constexpr Matrix2x3<Magnitude<T>> safeInverse(const Matrix2x3& fallback = Matrix2x3::EYE()) const
        //     noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        //
        ...
        //      */
        //     [[nodiscard("Inverse does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     static constexpr Matrix2x3<Magnitude<T>> safeInverseOf(const Matrix2x3& matrix,
        //                                                          const Matrix2x3& fallback = Matrix2x3::EYE())
        //                                                          noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        ...
        //      */
        //     [[nodiscard("Inverse does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     constexpr Matrix2x3<Magnitude<T>> tryInverse(OperationStatus& status,
        //                                                const Matrix2x3& fallback = Matrix2x3::EYE()) const noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      */
        //     [[nodiscard("Inverse does not mutate the matrix. Discarding the result will not produce any change.")]]
        //     static constexpr Matrix2x3<Magnitude<T>> tryInverseOf(const Matrix2x3& matrix, OperationStatus& status,
        //                                                         const Matrix2x3& fallback = Matrix2x3::EYE())
        //                                                         noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        ...
        //      */
        //     [[nodiscard]] static constexpr T trace(const Matrix2x3& matrix) noexcept
        //         requires StrictArithmetic<T>;
        //
        //     /** @} */
        ...
        //      */
        //     friend std::ostream& operator<<(std::ostream& os, const Matrix2x3& matrix)
        //     {
        ...
        //
        //     /**
        //      * @addtogroup FGM_Mat2x3_Transforms
        //      * @{
        //      */
        //
        //     /**
        ...
        //      *            \f$
        //      *
        //      * @note While it is possible to create a rotation matrix of any **signed type**, it is strongly
        //      discouraged.
        //      *       Trigonometric results will be truncated, resulting in severe precision loss and potential
        //      zero-matrices
        //      *       for integral types.
        //      *
        ...
        //      *
        //      * @return A new @ref Matrix2x3 representing the linear rotation.
        //      */
        //     template <std::floating_point U>
        //     [[nodiscard]] static constexpr Matrix2x3 makeRotation(U angle) noexcept
        //         requires SignedStrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      *
        //      * @return A new @ref Matrix2x3 representing the uniform scale.
        //      */
        //     [[nodiscard]] static constexpr Matrix2x3 makeScale(T scale) noexcept
        //         requires StrictArithmetic<T>;
        //
        //
        //     /**
        ...
        //      *
        //      * @return A new @ref Matrix2x3 representing the non-uniform scale.
        //      */
        //     [[nodiscard]] static constexpr Matrix2x3 makeScale(T scaleX, T scaleY) noexcept
        //         requires StrictArithmetic<T>;
        //
        //
        //     /**
        //      * @brief Construct a reflection 2D matrix for reflection along coordinate axis(X, Y), and the origin<0,
        //      0>.
        //      *
        ...
        //      *
        //      * @return A new @ref Matrix2x3 representing the axis-aligned reflection.
        //      */
        //     [[nodiscard]] static constexpr Matrix2x3 makeReflection(bool reflectX, bool reflectY) noexcept
        //         requires StrictArithmetic<T>;
        //
        //     /** @} */
        //
        ...
        //      */
        //     static constexpr Matrix2x3 EYE()
        //         requires fgm::StrictArithmetic<T>
        //     {
        //         return Matrix2x3{ T(1), T(0), T(0), T(1) };
        //     }
        //
        //
        //     /**
        ...
        //      * @note Constrained to @ref StrictArithmetic types.
        //      */
        //     static constexpr Matrix2x3 ZERO()
        //         requires fgm::StrictArithmetic<T>
        //     {
        //         return Matrix2x3{ T(0), T(0), T(0), T(0) };
        //     }
        //
        //
        //     // NOLINTEND
    ...
    //  *************************************/
    //
    // using Mat2B   = Matrix2x3<int8_t>;   ///< Signed Byte (8-bit) matrix
    // using Mat2UB  = Matrix2x3<uint8_t>;  ///< Unsigned Byte (8-bit) matrix
    // using Mat2I   = Matrix2x3<int32_t>;  ///< Signed Int (32-bit) matrix
    // using Mat2U   = Matrix2x3<uint32_t>; ///< Unsigned Int (32-bit) matrix
    // using Mat2F   = Matrix2x3<float>;    ///< Single Precision Floating Point (32-bit) matrix
    // using Mat2LL  = Matrix2x3<int64_t>;  ///< Signed Long Long (64-bit) matrix
    // using Mat2D   = Matrix2x3<double>;   ///< Double Precision Floating Point (64-bit) matrix
