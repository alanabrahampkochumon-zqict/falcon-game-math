 ...
 *
 * @brief Templated 2x4 Matrix supporting integral, floating-point, and boolean types.
 *
 * @details Provide high-performance 2x4 matrix implementation with SIMD acceleration
...
namespace fgm
{
    ...
    struct Mat2x4
    {
        ...
        /**
         * @brief Initialize an uninitialized @ref Mat2x4 instance.
         *
        ...
        /**
         * @brief Initialize a 2x4 matrix from the passed-in scalar elements.
         *
         ...
         */
        [[nodiscard]] constexpr Mat2x4(T m00, T m01, T m02, T m03, T m10, T m11, T m12, T m13) noexcept;


        /**
         * @brief Initialize a 2x4 matrix from the passed-in vectors as columns.
         *
         ...
         * @param[in] col3 The 2D vector to use as the fourth column entry.
         */
        [[nodiscard]] constexpr Mat2x4(const CVec2<T>& col0, const CVec2<T>& col1, const CVec2<T>& col2,
                                       const CVec2<T>& col3) noexcept;



        /**
         * @brief Initialize @ref Mat2x4 from another @ref Mat2x4 of a different type.
         *
        ...
        [[nodiscard]] explicit constexpr Mat2x4(const Mat2x4<U>& other) noexcept;
         ...
         *
         * @return A new @ref Mat2x4 containing the element-wise sum.
         */
        ...
        template <StrictArithmetic U>
            requires StrictSignedness<T, U>
        Mat2x4& operator+=(const Mat2x4<U>& rhs) noexcept
            requires StrictArithmetic<T>;
        ...
        [[nodiscard]] static constexpr PromotedMat2x4<T, S> safeDiv(const Mat2x4& mat, S scalar,
                                                                    Mat2x4 fallback = Mat2x4::zero()) noexcept
            requires StrictArithmetic<T>;
        ...
        /**
         * @brief Negate each element of this matrix and return a new @ref Mat2x4<T>.
         *
         * @note Operation is restricted to numeric types via @ref StrictArithmetic.
         *
        ...
        /**
         * @brief A 2x4 matrix with all elements being one.
         *
        ...
        /**
         * @brief A 2x4 matrix with all elements being zero.
         *
         * @note Constrained to @ref StrictArithmetic types.
         */
