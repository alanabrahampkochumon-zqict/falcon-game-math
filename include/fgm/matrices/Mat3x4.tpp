...
namespace fgm
{
    ...
    FGM_INLINE constexpr Mat3x4<T>::Mat3x4(const Mat3x4<U>& other) noexcept
    {
    ...
    template <Arithmetic T>
    FGM_INLINE constexpr Vec3<T>& Mat3x4<T>::operator[](const std::size_t col) noexcept
    {
    ...
    template <Arithmetic T>
    FGM_INLINE constexpr const Vec3<T>& Mat3x4<T>::operator[](const std::size_t col) const noexcept
    {
        FGM_ASSERT_MSG(col < COLUMNS, fgm::messages::assertion::MAT_OUT_OF_BOUNDS_ACCESS);
        return _data[col];
    }
    ...
    template <Arithmetic T>
    FGM_INLINE constexpr T& Mat3x4<T>::operator()(const std::size_t row, const std::size_t col) noexcept
    {
    ...
    template <Arithmetic T>
    FGM_INLINE constexpr const T& Mat3x4<T>::operator()(const std::size_t row, const std::size_t col) const noexcept
    {
        FGM_ASSERT_MSG(col < COLUMNS && row < ROWS, fgm::messages::assertion::MAT_OUT_OF_BOUNDS_ACCESS);
        return _data[col][row];
    }
    ...
    template <Arithmetic U>
        requires StrictSignedness<T, U>
    FGM_INLINE constexpr bool Mat3x4<T>::allEq(const Mat3x4<U>& rhs, const double epsilon) const noexcept
    {
    ...
    template <Arithmetic U>
        requires StrictSignedness<T, U>
    FGM_INLINE constexpr bool Mat3x4<T>::allEq(const Mat3x4& lhs, const Mat3x4<U>& rhs, const double epsilon) noexcept
    ...
    template <Arithmetic U>
        requires StrictSignedness<T, U>
    FGM_INLINE constexpr bool Mat3x4<T>::anyNeq(const Mat3x4<U>& rhs, const double epsilon) const noexcept
    {
        // MSVC's FGM_INLINE constexpr evaluator incorrectly yields true for NaN relational comparisons.
        // To enforce strict IEEE 754 compliance at compile-time, we explicitly short-circuit
        // if a NaN is detected. Runtime evaluation is safely deferred to hardware intrinsics.
    ...
    template <Arithmetic U>
        requires StrictSignedness<T, U>
    FGM_INLINE constexpr bool Mat3x4<T>::anyNeq(const Mat3x4& lhs, const Mat3x4<U>& rhs, const double epsilon) noexcept
    ...
    template <Arithmetic U>
        requires StrictSignedness<T, U>
    FGM_INLINE constexpr bool Mat3x4<T>::operator==(const Mat3x4<U>& rhs) const noexcept
    { return allEq(rhs); }
    ...
    template <StrictArithmetic U>
        requires StrictSignedness<T, U>
    FGM_INLINE constexpr PromotedMat3x4<T, U> Mat3x4<T>::operator+(const Mat3x4<U>& rhs) const noexcept
    ...
    template <StrictArithmetic U>
        requires StrictSignedness<T, U>
    FGM_INLINE constexpr Mat3x4<T>& Mat3x4<T>::operator-=(const Mat3x4<U>& rhs) noexcept
        requires StrictArithmetic<T>
    {
        _data[0] -= rhs[0];
        _data[1] -= rhs[1];
    ...
    FGM_INLINE constexpr PromotedMat3x4<T, S> Mat3x4<T>::operator*(const S scalar) const noexcept
        requires StrictArithmetic<T>
    {
    ...
    FGM_INLINE constexpr PromotedMat3x4<T, S> operator*(S scalar, const Mat3x4<T>& matrix) noexcept
        requires StrictArithmetic<T>
    ...
    template <Arithmetic T>
    template <StrictArithmetic S>
    FGM_INLINE constexpr Mat3x4<T>& Mat3x4<T>::operator*=(const S scalar) noexcept
        requires StrictArithmetic<T>
    {
        _data[0] *= scalar;
        _data[1] *= scalar;
    ...
    template <Arithmetic T>
    template <StrictArithmetic S>
    FGM_INLINE constexpr PromotedMat3x4<T, S> Mat3x4<T>::operator/(S scalar) const noexcept
        requires StrictArithmetic<T>
    {
        using R = PromotedValue_t<T, S>;
    ...
    template <Arithmetic T>
    template <StrictArithmetic S>
    FGM_INLINE constexpr PromotedMat3x4<T, S> Mat3x4<T>::safeDiv(const S scalar, Mat3x4 fallback) const noexcept
        requires StrictArithmetic<T>
    {
        using R = PromotedValue_t<T, S>;
    ...
    //
    //     template <Arithmetic T>
    //     FGM_INLINE constexpr Mat3x4<T> Mat3x4<T>::transpose() const noexcept
    //     {
    ...
    //
    //     template <Arithmetic T>
    //     FGM_INLINE constexpr Mat3x4<T> Mat3x4<T>::transpose(const Mat3x4& matrix) noexcept
    //     {
    //         return matrix.transpose();
    //     }
    ...
    template <Arithmetic T>
    FGM_INLINE constexpr bool Mat3x4<T>::hasInf() const noexcept
    { return _data[0].hasInf() || _data[1].hasInf() || _data[2].hasInf() || _data[3].hasInf(); }


    template <Arithmetic T>
    FGM_INLINE constexpr bool Mat3x4<T>::hasInf(const Mat3x4& matrix) noexcept
    { return matrix.hasInf(); }


    template <Arithmetic T>
    FGM_INLINE constexpr bool Mat3x4<T>::hasNaN() const noexcept
    { return _data[0].hasNaN() || _data[1].hasNaN() || _data[2].hasNaN() || _data[3].hasNaN(); }


    template <Arithmetic T>
    FGM_INLINE constexpr bool Mat3x4<T>::hasNaN(const Mat3x4& matrix) noexcept
