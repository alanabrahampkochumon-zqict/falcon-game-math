...
/** Verify @ref fgm::Mat4B has `int8_t` value_type. */
    ...
    static_assert(std::is_same_v<fgm::Mat4B, fgm::Matrix4<int8_t>> && "Mat4B must be an alias of Matrix4D<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat4I, fgm::Matrix4<int32_t>> && "Mat4I must be an alias of Matrix4D<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat4F, fgm::Matrix4<float>> && "Mat4F must be an alias of Matrix4D<float>");
    ...
    static_assert(std::is_same_v<fgm::Mat4D, fgm::Matrix4<double>> && "Mat4D must be an alias of Matrix4D<double>");
