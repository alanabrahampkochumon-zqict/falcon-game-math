...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Mat3B, fgm::Matrix3D<int8_t>> && "Mat3B must be an alias of Matrix3D<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat3UB, fgm::Matrix3D<uint8_t>> &&
    ...
    static_assert(std::is_same_v<fgm::Mat3I, fgm::Matrix3D<int32_t>> && "Mat3I must be an alias of Matrix3D<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat3U, fgm::Matrix3D<uint32_t>> &&
    ...
    static_assert(std::is_same_v<fgm::Mat3F, fgm::Matrix3D<float>> && "Mat3F must be an alias of Matrix3D<float>");
    ...
    static_assert(std::is_same_v<fgm::Mat3LL, fgm::Matrix3D<int64_t>> &&
    ...
    static_assert(std::is_same_v<fgm::Mat3D, fgm::Matrix3D<double>> && "Mat3D must be an alias of Matrix3D<double>");
    ...
    static_assert(std::is_same_v<fgm::Mat3ULL, fgm::Matrix3D<uint64_t>> &&
