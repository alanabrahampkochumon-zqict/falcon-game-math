...
namespace
{
    ...
    static_assert(std::is_same_v<fgm::Mat2B, fgm::Matrix2<int8_t>> && "Mat2B must be an alias of Matrix2D<int8_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat2I, fgm::Matrix2<int32_t>> && "Mat2I must be an alias of Matrix2D<int32_t>");
    ...
    static_assert(std::is_same_v<fgm::Mat2F, fgm::Matrix2<float>> && "Mat2F must be an alias of Matrix2D<float>");
    ...
    static_assert(std::is_same_v<fgm::Mat2D, fgm::Matrix2<double>> && "Mat2D must be an alias of Matrix2D<double>");
